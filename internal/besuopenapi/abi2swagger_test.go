...
const (
	unnamedInputsABI   = "[{\"inputs\":[{\"internalType\":\"uint256\",\"name\":\"\",\"type\":\"uint256\"},{\"internalType\":\"uint256\",\"name\":\"\",\"type\":\"uint256\"}],\"name\":\"get\",\"outputs\":[{\"internalType\":\"uint256\",\"name\":\"\",\"type\":\"uint256\"}],\"stateMutability\":\"view\",\"type\":\"function\"},{\"inputs\":[{\"internalType\":\"uint256\",\"name\":\"x\",\"type\":\"uint256\"}],\"name\":\"set\",\"outputs\":[],\"stateMutability\":\"nonpayable\",\"type\":\"function\"}]"
...
func TestABI2SwaggerUnnamedInputsABI(t *testing.T) {
	...
	expectedJSON, _ := ioutil.ReadFile("../../test/unnamedinput.swagger.json")
	assert.Equal(string(expectedJSON), string(swaggerBytes))
	assert.NotNil(swagger.Paths.Paths["/"].Post.Security)
	assert.NotNil(swagger.SecurityDefinitions)
	return
