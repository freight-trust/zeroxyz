...
func TestSolidityBytesParamConversion(t *testing.T) {
	...
	// Below test fails since zeroxyz expects bytes32 to be a hex string, should be enhanced to accept plain strings as well
...
func TestSendTxnABIParam(t *testing.T) {
	...
	msg.Method = &maidenlanedbind.ABIElementMarshaling{
		...
		Outputs: []maidenlanedbind.ABIArgumentMarshaling{
			{
				Name: "ret1",
				Type: "uint256",
			},
...
func TestNewSendTxnMissingParamTypes(t *testing.T) {
	assert := assert.New(t)
	_, err := NewSendTxn(&maidenlanedmessages.SendTransaction{
...
func TestCallMethod(t *testing.T) {
	...
	genMethod := func(params []interface{}) *abi.Method {
		uint256Type, _ := maidenlanedbind.ABITypeFor("uint256")
...
func TestProcessRLPBytesValidTypes(t *testing.T) {
	...
	t1, _ := maidenlanedbind.ABITypeFor("string")
	t2, _ := maidenlanedbind.ABITypeFor("int256[]")
	t3, _ := maidenlanedbind.ABITypeFor("bool")
	t4, _ := maidenlanedbind.ABITypeFor("bytes1")
	t5, _ := maidenlanedbind.ABITypeFor("address")
	t6, _ := maidenlanedbind.ABITypeFor("bytes4")
	t7, _ := maidenlanedbind.ABITypeFor("uint256")
	t8, _ := maidenlanedbind.ABITypeFor("int32[]")
	t9, _ := maidenlanedbind.ABITypeFor("uint32[]")
...
func TestProcessRLPBytesInvalidNumber(t *testing.T) {
	...
	t1, _ := maidenlanedbind.ABITypeFor("int32")
...
func TestProcessRLPBytesInvalidBool(t *testing.T) {
	...
	t1, _ := maidenlanedbind.ABITypeFor("bool")
...
func TestProcessRLPBytesInvalidByteArray(t *testing.T) {
	...
	t1, _ := maidenlanedbind.ABITypeFor("address")
