...
const (
	...
	RecordHeaderAccessToken = "besud-accesstoken"
)
...
type SendTransaction struct {
	TransactionCommon
	To         string                        `json:"to"`
	Method     *besudbind.ABIElementMarshaling `json:"method,omitempty"`
...
type DeployContract struct {
	...
	ABI             besudbind.ABIMarshaling `json:"abi,omitempty"`
